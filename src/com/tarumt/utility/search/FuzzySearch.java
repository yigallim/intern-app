...
public class FuzzySearch {
    ...
    public static Set<String> findFuzzyMatches_v4(String query, String sentence, double dlThreshold,
        ...
        List<Integer> matchedIndices = new DoublyLinkedList<>();
        ...
        List<List<Integer>> groups = new DoublyLinkedList<>();
        List<Integer> currentGroup = new DoublyLinkedList<>();
    ...
    public static <T extends BaseEntity> Result<T> searchList(Class<T> clazz, List<T> entities, String query,
                                                              String... excludeKeys) {
        Set<String> results = new HashSet<>();
        List<T> matchedEntities = new DoublyLinkedList<>();
